...
public class HistoryAll extends AppCompatActivity {
    ...
    private static final String TAG = HistoryAll.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addOnFavNew = (ImageButton) findViewById(R.id.addOnFavNew_history);

        backtomenu = (Button) findViewById(R.id.backToAllJobs_history);
        ...
        job_name_actv = (TextView) findViewById(R.id.jobname_all_job_history);

        job_type_actv = (TextView) findViewById(R.id.type_job_all_job_history);

        job_country_actv = (TextView) findViewById(R.id.country_text_all_job_history);
        job_region_actv = (TextView) findViewById(R.id.region_text_all_job_history);
        job_city_actv = (TextView) findViewById(R.id.city_text_all_job_history);

        job_payday_actv = (TextView) findViewById(R.id.payday_all_job_history);
        job_paydayvalue_actv = (TextView) findViewById(R.id.value_all_job_history);

        job_treb_actv = (TextView) findViewById(R.id.treb_all_job_history);
        job_grap_actv = (TextView) findViewById(R.id.graphik_all_job_history);

        job_Fname_actv = (TextView) findViewById(R.id.name_text_all_job_history);
        job_Sname_actv = (TextView) findViewById(R.id.otchestvo_all_job_history);
        job_phone_actv = (TextView) findViewById(R.id.phone_text_all_job_history);
        job_email_actv = (TextView) findViewById(R.id.email_text_all_job_history);
        ...
        addOnFavNew.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(flag_check == false)
                {
                    ...
                    String job_name = getIntent().getExtras().getString("jobname_historysearch_historyall");
    ...
    private void getAllHistory(){
        String tag_string_req = "req_get_all_history";

        pDialog.setMessage("Идет получение данных, пожалуйста подождите !");
        showDialog();

        String jNameID = getIntent().getExtras().getString("jobID_historysearch_historyall");
    ...
    public void gotoMenu(){
        ...
        /*String jTypeSearchAllResult = getIntent().getExtras().getString("jSearchType_all_result_n");
        String jNameAllResult = getIntent().getExtras().getString("jName_all_result_n");
        String jCityAllResult = getIntent().getExtras().getString("jCity_all_result_n");
        String jTypejobAllResult = getIntent().getExtras().getString("jType_all_result_n");


        intent.putExtra("Back_TypeSearch",jTypeSearchAllResult);
        intent.putExtra("Back_NameJob", jNameAllResult);
        intent.putExtra("Back_City", jCityAllResult);
        intent.putExtra("Back_Typejob", jTypejobAllResult);
        intent.putExtra("jSearchType_intent", jTypeSearchAllResult);*/

        Intent intent = new Intent(HistoryAll.this, HistorySearch.class);
